...
export const itemCardHomePage = [
  ...
  },
  {
    ...
    text: {
      ...
      textForDetailPage: `
        در بازرگانی یاراد، از فناوری‌های پیشرفته و سیستم‌های مدیریتی مدرن استفاده می‌کنیم تا عملیات تجاری شما بهینه‌تر انجام شود. امنیت ما، رضایت کامل مشتریان عزیز است، و برای دستیابی به این هدف، همواره در حال بهبود و نو‌آوری در فرآیندهای خود هستیم. تیم پشتیبانی 24/7 ما آماده پاسخگویی به نیازهای شماست و تمام تلاش خود را برای حل هرگونه مشکل در کوتاه‌ترین زمان ممکن صرف می‌کند. با انتخاب ما، تنها به موفقیت خود فکر کنید – ما به سایر جزئیات اطمینان می‌دهیم.
        `,
    },
    image: (
      <Image
  ...
  },
  {
    ...
    text: {
      ...
      textForDetailPage :`تیم ما با داشتن تجربه گسترده در حوزه واردات، به شما کمک می‌کند تا بهترین شرایط برای ثبت سفارش خود را ایجاد کنید. با استفاده از نرم‌افزارهای مدیریتی پیشرفته، تمامی اطلاعات سفارش‌ها را به صورت مرتب و دقیق ثبت می‌کنیم و از ضیاع اطلاعات جلوگیری می‌کنیم. همچنین، خدمات پشتیبانی 24/7 ما، اطمینان حاصل می‌دهد که هرگونه سوال یا مشکل شما در کوتاه‌ترین زمان ممکن حل شود. هدف ما، ارائه یک فرآیند ساده، سریع و بدون نگرانی برای مشتریان عزیز است.`
    },
    image: (
      <Image
        src={ImageFive}
